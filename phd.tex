...
\include{chapters/grundlagen/wirtschaftsverkehr/wirtschaftsverkehr}

\chapter{Emissions}
\label{ch:emissionen:}
\include{chapters/grundlagen/schadstoffe/schadstoffe}

\chapter{Modeling and Simulation}
\label{ch:modellierung-simulation}
\include{chapters/grundlagen/modSim/modSim}

\chapter{Scenarios}
\label{ch:modellierung-scenarios}
\include{chapters/grundlagen/scenarios/scenarios}
...
\include{chapters/2echolon/grid/grid}	 %  %article pubilshed in ...

\chapter{Auswirkungen einer Null-Emissions-Zone}
\label{ch:zeroEmissionZone}
\include{chapters/2echolon/zeroEmissionZone/zeroEmissionZone}	 % %article pubilshed in ...

\chapter{Auswirkungen eines Einfahrverbotes großer Fahrzeuge}
\label{ch:verbotGrosserFzg}
\include{chapters/2echolon/verbotGrosserFzg/verbotGrosserFzg}	 % s %article pubilshed in ...
...
\phantomsection
\raggedright
%\bibliography{../../../../documents/inputs/bib/vsp.bib,../../../../documents/inputs/bib/ref.bib,literature/literature-ik.bib,../../../../documents/inputs/bib/kai.bib,../../../../documents/inputs/bib/amit.bib}
%\bibliography{literature/literature-ik.bib}
...
\setstretch{1}
\bibliography{chapters/literature/thesis}
\bibliographystyle{chapters/literature/lastnamefirstabbrvnat}

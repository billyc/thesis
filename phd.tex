...
\part{Part I: MATSim Data Visualization Using Web-Based Technologies}
\label{part:1servers}
...
\part{Part II: Project Sites Using Client-Side Data Visualization Techniques}
...
\chapter{PAVE Project: Data Visualization for Analyzing the Potential of Automated Transport Systems}
\label{ch:pave}
...
\part{Part III: A Generalized Browser-Based Data Visualization Platform}
...
\input{chapters/appendix/appendix-a-python-r}

\chapter{SimWrapper platform documentation}
\label{appendix:simwrapper}
\input{chapters/appendix/appendix-b-simwrapper}

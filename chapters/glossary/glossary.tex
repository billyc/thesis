...
\newacronym[description={HTTP and its encrypted version HTTPS are the primary data transfer protocols used by websites}]
...
\newacronym{XML}{XML}{eXtensible Markup Language, a structured text format for data storage}

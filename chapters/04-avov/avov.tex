...
\begin{minipage}[c]{0.4\textwidth}
   \includegraphics[width=\linewidth]{chapters/04-avov/images/fig-drt-vehicles.png.pdf}
   \caption{DRT vehicles and routes}
   \label{fig:pave-drt-vehicles-routes}
\end{minipage}
\begin{minipage}[c]{0.4\textwidth}
   \includegraphics[width=\linewidth]{chapters/04-avov/images/fig-drt-flyovers.png.pdf}
...
\begin{figure}[ht]
  ...
  \begin{minipage}[c]{0.32\textwidth}
     \includegraphics[width=\linewidth]{chapters/04-avov/images/fig-link-vols.png.pdf}
     \caption{DRT Vehicle volumes, daily aggregation }
     \label{fig:pave-vehicles-daily}
  \end{minipage}
  \begin{minipage}[c]{0.32\textwidth}
     \includegraphics[width=\linewidth]{chapters/04-avov/images/fig-mode-share.png.pdf}
